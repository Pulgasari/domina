# domina — Ideen und Notizen

Gesammelte Brainstorm-Notizen, Wunschlisten und Analysen. Nichts hier ist
implementiert oder zugesagt — der Stand der Lib steht in `core/readme.md`.
